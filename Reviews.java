...
public class Reviews {
    private static LinkedList<Review> reviews; // ملاحظة: static مثل كودك (ممكن لاحقًا نخليه non-static)
    ...
    public Review SearchReviewById(int id) {
        ...
        reviews.findfirst();
        while (true) {
            if (reviews.retrieve().getReviewID() == id) return reviews.retrieve();
